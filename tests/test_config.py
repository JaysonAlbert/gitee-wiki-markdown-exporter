...
def test_load_settings_resolves_relative_output_and_environment_token(
        ...
        json.dumps(
            {
                ...
                "export": {"output_path": "mirror", "include_page_breadcrumbs": False},
                "sync": {"spaces": ["ENG", "ENG"]},
            }
        ),
        encoding="utf-8",
    ...
    assert settings.export.include_page_breadcrumbs is False
    ...
    assert rendered["export"]["include_page_breadcrumbs"] is False
